...
/**
 * Type-safe Lavalink Dragonfly Proxy Configuration
 * 
 * Supports both direct object configuration and environment variable overrides.
 */
export const config: LavalinkProxyConfig = {
    ...
    dragonfly: {
        ...
        searchTtlSeconds: Number(process.env.SEARCH_TTL || 259200), // 3 days
        trackTtlSeconds: Number(process.env.TRACK_TTL || 86400),   // 24 hours
        lyricsTtlSeconds: Number(process.env.LYRICS_TTL || 604800), // 7 days
        maxCachedEntries: Number(process.env.MAX_CACHED_ENTRIES || 100000), // Cap on total cached entries
    },
    eventHub: {
